...
def get_net(args):
    ...
    l_forward4 = LSTMLayer(l_forward3, num_units=num_hidden_units, unroll_scan=False, precompute_input=True)
    l_forward5 = LSTMLayer(l_forward4, num_units=num_hidden_units, unroll_scan=False, precompute_input=True)
    ...
    """
    l_shp = ReshapeLayer(l_forward5, (-1, num_hidden_units))
