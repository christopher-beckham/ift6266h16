...
def get_net(args):
    ...
    l_dropout1 = DropoutLayer(l_forward, p=args["dropout1"])
    l_forward2 = LSTMLayer(l_dropout1, num_units=num_hidden_units, unroll_scan=False, precompute_input=True)

    l_dropout2 = DropoutLayer(l_forward2, p=args["dropout2"])
    l_forward3 = LSTMLayer(l_dropout2, num_units=num_hidden_units, unroll_scan=False, precompute_input=True)
